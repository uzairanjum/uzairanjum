...
I build and scale AI-first SaaS products and custom AI solutions as a founding engineer, working closely with startups and freelance clients to turn ideas into production-ready systems. I’ve delivered AI-powered platforms for growing startups and enterprise-grade clients, with a strong focus on automation, conversational AI, and backend systems that support real business workflows and revenue growth.<br><br>

👯 I’m looking to collaborate on<br>
Startups, founders, and businesses looking for a hands-on AI engineer who can own architecture, build fast, and ship reliable AI products—from MVPs to scalable platforms.<br><br>

🤝 I’m looking for help with<br>
Expanding into new startup ecosystems, refining AI product positioning, and collaborating with founders on long-term, growth-focused builds.<br><br>

🌱 I’m currently learning<br>
Advanced LLM agent orchestration, voice AI pipelines, scalable backend architecture, and product strategy for AI-driven startups.<br><br>

💬 Ask me about<br>
Founding-engineer execution, AI agents for startups, FastAPI & backend architecture, RAG pipelines, voice bots, SaaS MVPs, and building client-ready AI systems that actually ship.<br><br>

⚡ Fun fact<br>
I thrive in fast-moving startup and freelance environments where clarity is low, timelines are tight, and execution matters more than buzzwords.
